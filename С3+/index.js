function deepComp(val1, val2) {
    ...
    val1 = (typeof val1 === 'number') ? val1 : objectSort(val1);
    val2 = (typeof val2 === 'number') ? val2 : objectSort(val2);

    if (val1 === val2) {
        return true;
    }

    if ((typeof val1 !== 'object') && (typeof val2 !== 'object') && isNaN(val1) && isNaN(val2)) {
        return true;
    }
